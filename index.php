...
<body>
      ...
      <div class="fb-home-timeline">
        ...
        <div class="create-post">
          <div class="create-post-header">
            <img src="./assets/images/user.png" alt="" />
            <button data-bs-toggle="modal" data-bs-target="#create_post">Whats on your mind ?</button>
          </div>
          <div class="divider-0"></div>
        ...
        <!-- User Post  -->
        <div id="devs_data" class="user-post">
      ...
      <div class="model-content">
        <div class="modal-body bg-white">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="my-2">
              <input type="text" type="text" class="form-control" name="posta_user_name" placeholder="Name">
            </div>
          </form>

            <div class="my-2">
              <label for="">Auth user photo</label>
              <input type="file" class="form-control" name="posta_user_photo" placeholder="Photo">
            </div>
            ...
            <div class="my-2">
              ...
              <input type="file" class="form-control" multiple name="posta_photos[]" placeholder="Photo">
            </div>
            
            <div class="my-2">
              <label class="bg-white" for="">video content</label>
              <input type="file" class="form-control" name="posta_video" placeholder="Photo">
            </div>
            
            <div class="my-2">
              <input type="submit" class="btn btn-primary btn-block w-100" name="post_submit" placeholder="Photo">
            </div>
  ...
  <div class="modal fade" id="create_post">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body bg-white">
          <div class="devs-head d-flex justify-content-between">
            <h3 id="createDevsModalLabel">Create New Post</h3>
            <button class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <hr>
          <form id="users_create_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
            <div class="my-2">
              <label for="posta_user_name">Auth User Name</label>
              <input type="text" class="form-control" name="posta_user_name" placeholder="Name">
            </div>

            <div class="my-2">
              <label for="posta_user_photo">Auth User Photo</label>
              <input type="file" class="form-control" name="post_user_photo" accept="image/*">
            </div>
            ...
            <div class="my-2">
              <label for="posta_photos">Post Photos</label>
              <input type="file" class="form-control" multiple name="post_photos[]" accept="image/*">
            </div>
            ...
            <!-- <div class="my-2">
              <label for="posta_photos">Post Photos</label>
              <input type="file" class="form-control"  name="post_photos" accept="image/*">
            </div> -->

            <!-- <div class="my-2">
              <label for="posta_video">Video Content</label>
              <input type="file" class="form-control" name="posta_video" accept="video/*">
            </div> -->

            <div class="my-2">
              <input type="submit" class="btn btn-primary btn-block w-100" name="post_submit" value="Post">
            </div>
          </form>
        </div>
      </div>
  ...
  /**
   * post comment mannaged
   */

  // if ($_SERVER["REQUEST_METHOD"] == "POST" && $_POST['comment_submit'] == "Submit Comment") {
  ...
  //         "comment_photo"  => $comment_photo_name ? $comment_photo_name : null,
  //         "comment_content"  => $comment_content ? $comment_content : null,
  //       ]);
  //     };

  //     array_push($comment_updata, $commentItem);
  //   };

  //   file_put_contents('./db/posts.json', json_encode($comment_updata));
  // }
  ...
  <div class="modal fade" id="create_comment_modal">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body bg-white">
          <form id="users_create_comment" action="" method="POST" enctype="multipart/form-data">
            <div class="my-2">
              <label for="comment_user_name">Auth User Name</label>
              <input type="text" class="form-control" name="comment_user_name" placeholder="Name" required>
            </div>

            <div class="my-2">
              <label for="comment_user_photo">Auth User Photo</label>
              <input type="file" class="form-control" name="comment_user_photo" accept="image/*">
            </div>

            <!-- <div class="my-2">

              <input class="form-control" name="comment_id" id="comment_id">
            </div> -->

            <div class="my-2">
              <label for="comment_content">Comment Content</label>
              <textarea name="comment_content" id="comment_content" class="form-control" placeholder="Write your comment here..." required></textarea>
            </div>

            <!-- <div class="my-2">
              <label for="comment_photo">Comment Photo</label>
              <input type="file" class="form-control" name="comment_photo" accept="image/*">
            </div> -->

            <div class="my-2">
              <input type="submit" name="comment_submit" class="btn btn-primary btn-block w-100" value="Submit Comment">
            </div>
          </form>
        </div>
      </div>
  ...
  <script>
    const commentbtn = document.querySelectorAll('.comment_click');
    const commentid = document.getElementById('comment_id');

    commentbtn.forEach(item => {
      // console.log(event.target);
      item.onclick = (event) => {
        commentid.value = event.target.getAttribute('commentid')
      }
    })
  </script> -->
